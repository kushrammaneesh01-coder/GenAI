...
# installed.
TCL_PREFIX='/workspaces/GenAI/conda-env'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/workspaces/GenAI/conda-env'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /workspaces/GenAI/conda-env/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/tk_1769459871528/work=/usr/local/src/conda/tk-8.6.13 -fdebug-prefix-map=/workspaces/GenAI/conda-env=/usr/local/src/conda-prefix -pipe -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /workspaces/GenAI/conda-env/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,--allow-shlib-undefined -Wl,-rpath,/workspaces/GenAI/conda-env/lib -Wl,-rpath-link,/workspaces/GenAI/conda-env/lib -L/workspaces/GenAI/conda-env/lib -Wl,--export-dynamic '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/workspaces/GenAI/conda-env/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/workspaces/GenAI/conda-env/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/workspaces/GenAI/conda-env/include'
...
# compiled.
TCL_SRC_DIR='/workspaces/GenAI/conda-env/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/workspaces/GenAI/conda-env/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/workspaces/GenAI/conda-env/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/workspaces/GenAI/conda-env/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/workspaces/GenAI/conda-env/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/workspaces/GenAI/conda-env/lib/libtclstub8.6.a'
